...
function setupEvents() {
    ...
    const switchTab = (viewId) => {
        ...
        Object.values(tabs).forEach(btn => {
            if(btn) btn.className = "w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-700 dark:hover:text-slate-300 font-semibold text-sm transition-all text-left";
        });
        ...
        const activeDesktop = "w-full flex items-center gap-3 px-3 py-2.5 rounded-xl bg-indigo-50 dark:bg-indigo-950/50 text-indigo-600 dark:text-indigo-400 font-bold text-sm transition-all text-left";
